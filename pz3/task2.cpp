...
1. Формування, друк і обробку масивів оформити у вигляді функції.
Масиви передавати як параметри функцій.
2. Реалізувати масиви як псевдодинамічні, їх розмірності
передавати як параметри функцій.
3. Формування масивів виконати з використанням ДСЧ.
В масиви записувати і + і - числа.
4. Сортування масивів організувати за допомогою одного з простих
методів сортування.
5. Функція main повинна містити тільки опис масивів і
виклики функцій для формування, друку та обробки масивів.
*/
#include <iostream>
